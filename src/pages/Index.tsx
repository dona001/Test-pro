...
import { Zap, Package, ChevronDown, ChevronUp } from "lucide-react";
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="text-center mb-16">
              <div className="flex items-center justify-center mb-6">
                <div className="w-20 h-20 bg-gradient-to-r from-blue-600 to-indigo-600 rounded-2xl flex items-center justify-center mr-6 shadow-lg animate-scale-in">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
              ...
              <Card className={`group cursor-pointer transition-all duration-300 border-2 hover:scale-105 hover:shadow-2xl ${
                selectedMode === 'manual' 
                ...
                <CardContent className="p-8 text-center">
                  ...
                  <p className={`mb-6 text-base ${selectedMode === 'manual' ? 'text-blue-600' : 'text-gray-600'}`}>
                    Start testing immediately by building custom requests. Perfect for quick tests and debugging.
                  </p>
                  ...
                  <Button 
                    onClick={() => {
                      ...
                      setTimeout(() => {
                        ...
                        testingSection?.scrollIntoView({ behavior: 'smooth', block: 'start' });
                      }, 100);
                    }}
              ...
              <Card className={`group cursor-pointer transition-all duration-300 border-2 hover:scale-105 hover:shadow-2xl ${
                ...
                <CardContent className="p-8 text-center">
                  ...
                  <p className={`mb-6 text-base ${selectedMode === 'import' ? 'text-purple-600' : 'text-gray-600'}`}>
                    Import Postman or OpenAPI collections for comprehensive testing. Ideal for complete API suites.
                  </p>
                  <div className="space-y-3 mb-6">
                    <div className="flex items-center justify-center text-sm text-gray-500">
